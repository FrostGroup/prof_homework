package week3.OpenWeather.model;
...
public final class Weather {
    ...
    public Weather(City city, String cod, double message, long cnt, List[] list){
        this.city = city;
        this.cod = cod;
    ...
    public static final class List {
        ...
        public static final class Main {
            ...
            public Main(double temp, double temp_min, double temp_max, double pressure, double sea_level, double grnd_level, long humidity, long temp_kf){
                this.temp = temp;
        ...
        public static final class Weatherr {
            public final long id;
            public final String main;
            public final String description;
            public final String icon;

            public Weatherr(long id, String main, String description, String icon){
                this.id = id;
                this.main = main;
